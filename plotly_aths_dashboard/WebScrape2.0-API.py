...
url = "https://ghjwvnyk3fcyxmxbpvdj4vnlge.appsync-api.eu-west-1.amazonaws.com/graphql"
    ...
    for athlete in ath_id:
        ...
        for year in range(2012, 2023):  # for loop to extract only data from 2012-2022 (2023 is not included in range)
            try:
                ...
                headers = {
                  'authority': 'ghjwvnyk3fcyxmxbpvdj4vnlge.appsync-api.eu-west-1.amazonaws.com',  # edit from cURL
                  'accept': '*/*',
                  ...
                  'x-api-key': 'da2-rcxz3u7cfrbtfnpxjtf6prue3i'  # edit from cURL
                ...
                for result in data["data"]["getSingleCompetitorResultsDate"]["resultsByDate"]:  # goes down each key phrase in json
                    ...
                    res_data.to_csv("NewestathsDF.csv", mode='a', header=False, index=False)  # change csv file path to create new copy
            except TypeError:
                year = year + 1
